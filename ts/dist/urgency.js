...
var Obsidian;
(function (Obsidian) {
    var _Urgency_dv, _Urgency_conf;
    class Urgency {
        constructor(dv, conf) {
            _Urgency_dv.set(this, void 0);
            _Urgency_conf.set(this, void 0);
            __classPrivateFieldSet(this, _Urgency_dv, dv, "f");
            __classPrivateFieldSet(this, _Urgency_conf, conf, "f");
        }
        compute() {
        }
        getScore() {
    ...
    _Urgency_dv = new WeakMap(), _Urgency_conf = new WeakMap();
    Obsidian.Urgency = Urgency;
})(Obsidian || (Obsidian = {}));
